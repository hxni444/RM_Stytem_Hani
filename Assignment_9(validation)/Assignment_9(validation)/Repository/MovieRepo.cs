...
namespace Assignment_9_validation_.Repository
{
    public class MovieRepo : ImovieRepo
    {
        List<Movie> movie_List = new List<Movie>()
        {
            ...
            new Movie(){MovieId=456,Actor="Jaya",Director="unni k",MovieName="Namma",Lang="malayalm",ReleaseYear= 2023},
            new Movie(){MovieId=456,Actor="Lal",Director="Madu",MovieName="MoonMan",Lang="malayalm",ReleaseYear= 2024}
        };
